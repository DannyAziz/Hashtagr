    ...
    Function && Function.prototype && Function.prototype.bind && (/MSIE [678]/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || ! function(t) {
        ...
        return e.e = function(t, e) {}, e.e = function(t, n) {
            ...
            if (void 0 !== i[t]) i[t].push(n);
                ...
                o.type = "text/javascript", o.charset = "utf-8", o.async = !0, o.onerror = function() {
                    ...
                    1: "0308b81ff1714e446f674b5b9793f2cd",
                    2: "1fa128383bdd8af67ce0cdc9a469ddaa",
                    3: "f4bf3babfa22a537b5d02331280e3883",
                    4: "e158f34e73111f999d67f75e522e0576",
                    5: "d11f7a3b3287fb94220e8ee6d03cc772",
        ...
        (function(t) {
            ...
            (function() {
                ...
                function C(t, e) {
                    t._state === nt && (t._result = e, t._state = rt, 0 !== t._subscribers.length && J(R, t))
                }
                ...
                function N(t, e, n, r) {
                    var i = t._subscribers,
                        o = i.length;
                    t._onerror = null, i[o] = e, i[o + rt] = n, i[o + it] = r, 0 === o && t._state && J(R, t)
                }
                ...
                function P(t, e, n, r) {
                    var i, a, s, u, c = o(n);
                    if (c) {
                        if (i = S(n, r), i === at ? (u = !0, a = i.error, i = null) : s = !0, e === i) return void I(e, w())
                    } else i = r, s = !0;
                ...
                function U(t) {
                    this._id = lt++, this._state = void 0, this._result = void 0, this._subscribers = [], v !== t && (o(t) || M(), this instanceof U || B(), O(this, t))
                }
                ...
                var ut = D,
                    ...
                    lt = 0,
                    ht = U;
                U.all = ut, U.race = ct, U.resolve = ft, U.reject = dt, U._setScheduler = s, U._setAsap = u, U._asap = J, U.prototype = {
                    constructor: U,
                    then: function(t, e) {
                        var n = this,
                            r = n._state;
        ...
        E.set("verifyCSP", function(t) {
            ...
            var t;
            return y.asBoolean(_.val("widgets:csp")) ? A = !0 : (t = p.createElement("script"), t.id = C, t.text = E.fullPath("verifyCSP") + "(false);", p.body.appendChild(t), void v.setTimeout(function() {
        ...
        s = (new c).defaults({
            ...
            var n = e && "click" == e.type && d.closest("a", e.target),
                ...
                o = n && (l.ios() || l.android());
            return h.isTwitterURL(t) ? r || o ? this : (this.name = i(), this.popup = this.win.open(t, this.name, this.features), e && f.preventDefault(e), this) : void 0
        ...
        function i(t) {
            var e = t.map(a.fromRawTask),
                n = r(e);
            d.forIn(n, function(t, e) {
                c.allSettled(e.map(function(t) {
                    return t.initialize()
                })).then(function() {
                    e.forEach(function(t) {
                        u.all([t.hydrate(), t.insertIntoDom()]).then(f(t.render, t)).then(f(t.success, t), f(t.fail, t))
                    })
                })
            })
        }
        ...
        r.fromRawTask = function(t) {
            return new r(t.input, t.taskDoneDeferred.resolve)
            ...
            var t = this;
            return this._srcEl ? c.always(o.write(function() {
                i.add(t._srcEl, t._errorClassName)
            }), function() {
                a.trigger("rendered", {
                    target: t._srcEl
                }), t._resolve(t._srcEl)
            }) : (t._resolve(), u.resolve())
        ...
        function a(t) {
            t.overrideProperty("id", {
                ...
                var s = this,
                    u = new v,
                    c = r(t, e, n);
                return f.write(_(a, null, c)), c.addEventListener("load", function() {
                    i(c).then(null, _(o, null, t, e, n, c)).then(u.resolve, u.reject)
        ...
        t.exports = [n(71), n(102), n(144), n(150), n(156), n(187), n(200), n(205)]
    }, function(t, e, n) {
        function r(t) {
            var e = s(t),
                n = {
        ...
        t.exports = {
            css: "47ab5d19e8ed22531abcf4f86f3ae53a"
        }
    }, , function(t, e, n) {
        function r() {
            return f + d++
        ...
        function a(t, e) {
            e = void 0 !== e ? !!e : g.retina(), v.toRealArray(t.getElementsByTagName("IMG")).forEach(function(t) {
        ...
        function u(t, e) {
            t && (g.ios() || g.android()) && v.toRealArray(t.querySelectorAll(".FilledIframe")).forEach(function(t) {
                e(function() {
                    l(t, {
                        width: t.offsetWidth,
        ...
        function c(t, e, n, r) {
            t && (u(t, r), v.toRealArray(t.querySelectorAll("iframe.autosized-media, .wvp-player-container")).forEach(function(t) {
                var i = d(t.getAttribute("data-width"), t.getAttribute("data-height"), y.effectiveWidth(t.parentElement) || e, n);
                r(function() {
                    t.setAttribute("width", i.width), t.setAttribute("height", i.height), b.present(t, "wvp-player-container") ? (t.style.width = i.width, t.style.height = i.height) : (t.width = i.width, t.height = i.height, l(t, i))
                })
            }))
        }
        ...
        function l(t, e) {
            ...
            var r, i, o, a, s;
            t && (i = t.contentWindow, r = t.ownerDocument && t.ownerDocument.defaultView, o = g.ios() || g.android(), a = w.isTwitterURL(t.src), s = i && g.canPostMessage(i), o && a && s && (n(), r && r.addEventListener("message", function(t) {
        ...
        function p(t) {
            g.cspEnabled() && (h(t, ".MediaCard-widthConstraint", "maxWidth", _), h(t, ".MediaCard-mediaContainer", "paddingBottom", A), h(t, ".CroppedImage-image", "top", E), h(t, ".CroppedImage-image", "left", x))
        }
        var m = n(7),
            v = n(14),
            g = n(8),
        ...
        t.exports = {
            ...
            setSrcForImgs: s,
            sizeIframes: c,
            broadcastIframeResize: u,
            constrainMedia: f,
            fixMediaCardLayout: p,
            __setSrcFromSet: o
        }
    }, function(t, e) {
        function n(t) {
        ...
        function r(t) {
            t.params({
                ...
                t.getAttribute(d) || (t.setAttribute(d, !0), t.href = u.url(t.href, {
